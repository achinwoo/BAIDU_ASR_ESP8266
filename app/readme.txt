...
AT+KWS=hello
AT+KWS=?
AT+SPHMOD=FAST/NORMAL
AT+SPHMOD=?
AT+DEVPID=1536/
AT+DEVPID=?
AT+VAD=1/0
AT+VAD=?
AT+SPEECH=START/STOP MAX 60S
AT+SSID=SSID,PWD
AT+APIKEY=APIKey,SecretKey
AT+VER=?
AT+HELP=?
AT+CMD=1,打开电灯,关闭电灯
...
AT+PIT=0-15
AT+VOL=0-15
AT+PER=0-1-3-4-5-103-106-110-111

AT+OTAUP=http://www.index.com/up.bin

AT+FILEOPEN=NAME,Len
AT+FILECLOSE=1
AT+FILESEND=DATA,LEN
